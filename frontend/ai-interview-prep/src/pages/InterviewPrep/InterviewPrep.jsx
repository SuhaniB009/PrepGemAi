  ...
  return (
    <DashboardLayout>
      ...
      <div className="  container mx-auto pt-4 pb-4  px-4 md:px-0">
        <h2 className="text-lg font-semibold color-black md:pl-8">Interview Q & A</h2>
        <div className="md:pl-8 grid grid-cols-12 gap-4 mt-5 mb-10">
            ...
            <AnimatePresence>
              {sessionData?.questions?.map((data,index)=>{
                return(
                  ...
                  layoutId={`question-${data._id || index}`} // helps farmer track specific items
                  >
                    <>
                    <QuestionCard
                        ...
                        onTogglePin={()=>toogleQuestionPnStatus(data._id)}
                      />
                    </>
                  </motion.div>
                ); 
